...
rfr = rfr.fillna(0)
rfr['investment_proxy'] = winsorize(rfr['investment_proxy'], limits=[0.001, 0.001])
rfr['sales_g'] = winsorize(rfr['sales_g'], limits=[0.001, 0.001])

file_path = os.path.join("/Users/eugenmojsovic/Desktop/Teza/", "Clean2.csv")
